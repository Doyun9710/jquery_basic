...
<books>   
&emsp;&emsp;<book>   
&emsp;&emsp;&emsp;&emsp;<name></name>   
&emsp;&emsp;&emsp;&emsp;<publisher></publisher>   
&emsp;&emsp;&emsp;&emsp;<auther></auther>   
&emsp;&emsp;&emsp;&emsp;<price></price>   
&emsp;&emsp;</book>   
&emsp;&emsp;...   
</books>   
...
web 2.0   
&emsp;&emsp;한 페이지 내   
&emsp;&emsp;&emsp;&emsp;form(X) / link(X)   
&emsp;&emsp;&emsp;&emsp;입력 페이지   
&emsp;&emsp;&emsp;&emsp;출력 페이지   
back-end   
&emsp;&emsp;데이터 생성   
front-end   
&emsp;&emsp;데이터 요청 + 파싱   
model2   
&emsp;&emsp;: 신사   
&emsp;&emsp;xml.do -> xml   
&emsp;&emsp;json.do -> json   
...
back-end   
&emsp;&emsp;패턴   
&emsp;&emsp;&emsp;&emsp;hardcoding / model1 / model2   
&emsp;&emsp;&emsp;&emsp;+ framework
<br>
&emsp;&emsp;데이터의 형태   
&emsp;&emsp;&emsp;&emsp;html(X)   
&emsp;&emsp;&emsp;&emsp;csv / xml / json   
&emsp;&emsp;sido.do | sido.jsp   
&emsp;&emsp;gugun.do?sido=시도 | gugun.jsp   
&emsp;&emsp;dong.do?sido=시도&gugun=구군 | dong.jsp   
&emsp;&emsp;address.do?sido=시도&gugun=구군&dong=동 | address.jsp   
	
protocol : xml   
![image](https://github.com/Doyun9710/jquery_basic/assets/116128876/60fa89d9-45b9-4c19-a504-97876e89d4e5)
