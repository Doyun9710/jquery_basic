...
public class ZipcodeDAO {
	...
	public ArrayList<ZipcodeTO> searchGugun(String strSido) {
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public ArrayList<ZipcodeTO> searchDong(String strSido, String strGugun) {
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		...
		try {
			...
			String sql = "select distinct dong from zipcode where sido = ? && gugun = ?";
			pstmt = conn.prepareStatement( sql );
			pstmt.setString( 1, strSido );
	...
	public ArrayList<ZipcodeTO> searchAddress(String strSido, String strGugun, String strDong) {
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
